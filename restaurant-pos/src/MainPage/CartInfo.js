...
const CartInfo = () => {
    ...
    const point = localStorage.getItem("point") ? JSON.parse(localStorage.getItem("point")) : "";
                    ...
                    <div className="row">
                        ...
                        <div className="col-2">
                            <button
                                ...
                                onClick={() => {
                                    addCart(y[0], x[0], x[1], parseInt(x[2]) - 1, x[3]);
                        ...
                        onClick={async () => {
                            if (user && !isDis) {
                                ...
                                localStorage.setItem(
                                    "point",
                                    JSON.stringify(point + numsum * 0.05)
                                );
                                ...
                                localStorage.setItem(
                                    "point",
                                    JSON.stringify(point + numsum * 0.04 - 5000)
                                );
                                const userd = firebase.database().ref("Accounts").child(id);
                                await userd.update({
